...
# Define colors
set linetype 1 lc rgb "#800074"  # mvm_ckpt_time
set linetype 2 lc rgb "#cecece"  # mvm_restore_time
set linetype 3 lc rgb "#1a80bb"  # ckpt_time
set linetype 4 lc rgb "#a00000"  # ckpt_restore_time
set linetype 5 lc rgb "#298c8c"  # simple_ckpt_time
set linetype 6 lc rgb "#f1a226"  # simple_restore_time
...
plot 'plot_data.csv' using ($5-step/5):($9+$10) skip 1 with boxes lt 2 title "mvm restore time", \
     '' using ($5-step/5):($9) skip 1 with boxes lt 1 title "mvm ckpt time", \
