...
#if MOD == 64
    int ckpt_code_size = 0xe2; // this is taken from the compiled version of the src/_asm_patch.S file
#elif MOD == 128
    int ckpt_code_size = 0xff;
#elif MOD == 256
    int ckpt_code_size = 0xfd;
#else
    int ckpt_code_size = 0x109;
#endif
#endif
